...
ISSUES = {
    ...
    "TIK-TECH-009": ("APPROVE", "DONE", "VERIFIED", "PASS", "IT Dev", "1", "✅ VERIFIED", "None — deploy reverse-proxy template", "HTTP→HTTPS live. www→apex in nginx template.", "HTTP 301 to HTTPS verified on production.", "EV-05"),
    ...
    "TIK-TECH-016": ("APPROVE", "DONE", "VERIFIED", "PASS", "IT Dev", "1", "✅ VERIFIED", "None — deploy reverse-proxy template", "Canonical host tikramarabia.com; www→apex in template.", "siteConfig + nginx template use apex.", "EV-05"),
...
EVIDENCE = [
    ...
    ("EV-05", "TIK-TECH-009, TIK-TECH-016", "ev-05-https-www.png", "HTTP→HTTPS 301 on production; www→apex in reverse-proxy template."),
    ...
    ("EV-16", "TIK-TECH-003, TIK-TECH-022, TIK-TECH-024, TIK-TECH-038", "ev-16-rejected-fonts.png", "SSR/mobile-stack REJECTED (React/PERN). Fonts async from Google — self-host skipped."),
    ("EV-17", "TIK-TECH-033", "ev-17-contact.png", "Production /contact returns HTTP 200 — audit finding was incorrect."),
    ("EV-18", "TIK-TECH-001 to 038", "ev-18-prod-pending-deploy.png", "Live tikramarabia.com still serves the old 967-byte SPA shell until the SEO build is deployed."),
]
